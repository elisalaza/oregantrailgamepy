...
def play_game():
    add_spaces()
    print("""Is man the only animal to stuggle in nature?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
General Store Clerk: You seem to be on your way about the Oregon trail. The first thing you'll need to do is choose some supplies. What did you say your name was again?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                     
                     Farmer Joe (A): Complete Survival Package ~ includes Food,Water, Tools, Clothing, Oxen, First Aid. Cost: $500
                      
                      Dr Mulberry (B): Medium Survival Package ~ includes Food, Water, Oxen, First Aid. Cost: $250
                      
                      Businessman Roger (C):Minimalist Package ~ includes Food, Water,Oxen. Cost: $100""")
...
# snake bite
    if new_event == " Snake Bite!":
        ...
        if supply == "A":
            ...
            time.sleep(3)
            print("You intruct your wife on how to safely remove the posion from your body and devolop and antivenom")
...
#river
        ...
        if supply == "A":
            ...
            print("Your wit and negotion tacitics have saved you! You can afford anything!")
            continue_path(supply)
        else:
            return
#dysentary
        ...
        if supply == "A":
            ...
            print("You create penecillin from mold to treat yourself")
            time.sleep(3)
            time_space()
            continue_path(supply)
        elif supply == "C":
 ...
 #aliens
        ...
        if supply == "A":
            ...
            time_space()
            print("You negotiate a peace deal on the planet vulix. The aliens are happy to let you go.")
            continue_path(supply)
        else:
            return
...
#bandits
        ...
        if supply == "A":
            ...
            time_space()
            print("You charm the bandits with cigars and brandy! You escape once they have fallen asleep.")
            continue_path(supply)
    else:
        return
...
def random_death(supply):
    ...
    if random.choice(life_death) == life:
        ...
        print(death)
        add_spaces()
        prompt = input("Would you like to play again? Type Y / N ")
        if prompt.upper() == 'Y':
          play_game()
        elif prompt.upper()== 'N':
          vol_end()
...
def start():
    add_spaces()
    print("General Store Clerk: Good luck on the trail!")
    add_spaces()
    time_space()
